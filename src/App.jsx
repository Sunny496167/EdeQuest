...
import LearningInsights from './pages/analytics/LearningInsights';
// Parent Portal Pages
import NewParentDashboard from './pages/parent/ParentDashboard';
import ChildProfileManagement from './pages/parent/ChildProfileManagement';
import DetailedActivityLog from './pages/parent/DetailedActivityLog';
import PerformanceOverview from './pages/parent/PerformanceOverview';
import ScreenTimeManagement from './pages/parent/ScreenTimeManagement';
import ContentControls from './pages/parent/ContentControls';
            ...
            <ParentProvider>
              <GamificationProvider>
                <Routes>
                  ...
                  <Route path="/parent/screen-time" element={
                    <ProtectedRoute>
                      <ScreenTimeManagement />
                    </ProtectedRoute>
                  } />
                  <Route path="/parent/content-controls" element={
                    <ProtectedRoute>
                      <ContentControls />
                    </ProtectedRoute>
                  } />
